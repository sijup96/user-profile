...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className='text-slate-300 text-xl w-1/2 flex '><Link to={'/admin'}>Home</Link> </div>
        <div className='text-slate-300 text-xl w-1/2 justify-center flex'>Welcome {adminInfo?.email}</div>
        {(adminInfo && <div className='mr-10 space-x-3 w-1/2 flex items-center justify-end'>
